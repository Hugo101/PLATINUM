...
class SMIselection(nn.Module):
    def __init__(self, num_cls, select_true_label, scenario, selection_option, is_inner, verbose):
        super().__init__()
    ...
    def smi_select(self, support_inputs, support_targets,
        ...
        if(embedding_type == "gradients"):
            unlabeled_data_embedding = strategy_obj.get_grad_embedding(params, unlabeled_set, True, "bias_linear")  # (250,8005)
