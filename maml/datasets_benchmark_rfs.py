...
def get_benchmark_by_name_rfs(name,
    ...
    if name == 'miniimagenet':
        ...
        model = MetaResNet12Model(num_ways, hidden_size=hidden_size)
        ...
        model = MetaResNet12Model(num_ways, hidden_size=hidden_size) # todo: check
        loss_function = F.cross_entropy
        swn_model = swn(64)
